      ...
      : [
          {
            ...
            desc: "Customized lesson plans for every student",
          },
          {
            icon: Shield,
            title: "Result Guarantee",
            desc: "Money back if your score doesn't improve",
          },
          {
            icon: Clock,
          ...
          },
          {
            ...
            desc: "Teachers who are IELTS examiners",
          },
        ]
      ...
      : [
          {
            name: "Madina Shermatova",
            role: "Academic 8.0",
            text: "This platform changed my life. I went from 5.5 to 8.0 in just 3 months!",
            image: "MS",
          },
          {
            name: "Sardor Umrzoqov",
            role: "General 7.5",
            text: "The teachers are very qualified. Every lesson is productive. Highly recommend!",
            image: "SU",
          },
          {
            name: "Aygul Rahmonova",
            role: "Academic 8.5",
            text: "Online classes are so convenient. I achieved success studying with my family.",
            image: "AR",
          },
        ]
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="text-lg font-semibold mt-2 text-gray-900 dark:text-white">
                        {card.name}
                      </div>
                    </div>
        ...
        <section className="py-12 sm:py-16 px-4 bg-gray-50 dark:bg-gray-950">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 sm:mb-24">
              ...
              <StaggerText
                key={`whyus-title-${language}`}
                text={content.whyUsTitle}
                className="text-4xl sm:text-5xl lg:text-6xl font-black mt-2 leading-[1.1] tracking-tight text-gray-900 dark:text-white"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {whyUs.map((item, i) => (
                <motion.div
                  key={`whyus-item-${i}`}
                  whileHover={{ y: -10 }}
                  className="bg-white dark:bg-gray-900 p-8 sm:p-10 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-2xl hover:border-red-500/30 transition-all duration-300"
                >
                  ...
                  <h3 className="text-xl sm:text-2xl font-black mb-4 leading-tight text-gray-900 dark:text-white">
                    {item.title}
                  </h3>
        ...
        <section className="py-20 sm:py-28 px-4 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 sm:mb-20">
              ...
              <StaggerText
                key={`team-title-${language}`}
                text={content.teamTitle}
                className="text-4xl sm:text-5xl lg:text-7xl font-black mt-2 leading-[1.1] tracking-tight text-gray-900 dark:text-white"
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {teachers.length > 0 ? (
                teachers.map((teacher, i) => (
                  <motion.div
                    key={`teacher-${teacher.id}-${i}`}
                    whileHover={{ y: -10 }}
                    className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 overflow-hidden shadow-[0_15px_40px_rgba(15,23,42,0.08)] hover:shadow-[0_25px_60px_rgba(185,28,28,0.15)] transition-all duration-300 flex flex-col"
                  >
                    {/* Avatar Area */}
                    <div className="relative p-6 pb-0">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0 pt-1">
                          <h3 className="font-black text-lg sm:text-xl mb-1 text-gray-900 dark:text-white">
                            {teacher.name}
                          </h3>
                    ...
                    <div className="p-6 pt-5 flex-1 flex flex-col">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-5">
                        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-3 text-center">
                          ...
                          <p className="text-[10px] uppercase tracking-wider text-gray-400 dark:text-gray-300 font-bold">
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-300 leading-relaxed mb-6 line-clamp-2">
                        {language === "uz"
                          ...
                          : "Professional IELTS & Speaking coach. Helped 1000+ students achieve success."}
                      </p>
                      ...
                      <Button
                        ...
                        size="sm"
                        variant="secondary"
                        className="mt-auto !rounded-2xl !py-2.5 text-xs dark:!bg-gray-800 dark:!border-gray-700 dark:!text-gray-100"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, i) => (
                <motion.div
                  key={`testimonial-${i}`}
                  whileHover={{ y: -10 }}
                  className="bg-white dark:bg-gray-900 p-8 sm:p-10 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-xl hover:shadow-2xl transition-all duration-300 h-full flex flex-col"
                >
                  ...
                  <div className="flex items-center gap-4 mt-auto">
                    ...
                    <div>
                      <div className="font-black text-lg leading-none mb-1 text-gray-900 dark:text-gray-100">
                        {testimonial.name}
                      </div>
        ...
        <section className="py-20 sm:py-28 px-4 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 sm:mb-20">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-7xl font-black mt-2 leading-[1.1] tracking-tight text-gray-900 dark:text-white">
